            ...
            <div className="sidebar">
                ...
                <div className="sidebar-menu">
                            ...
                            <>
                                ...
                                <div className="overflow-hidden" ref={ setCollapsibleElement }>
                                    <div className="submenu">
                                        ...
                                        <div role="button" className="menu-item submenu-item">
                                            <a role="button" href="https://tally.zendesk.com/hc/en-us/articles/4410051670161-Unique-Tally-NFT-Earn-NFT-Collection-The-Best-NFT-Integration-on-BSC-">About</a>
                                        </div>
                                    </div>
                                </div>
                            </>
                    ...
                    <div className="menu-item warning" role="button">
                        <a role="button" target="_self" href="/scamtokens">
                            <svg viewBox="0 0 24 24" width="24px" color="text" xmlns="http://www.w3.org/2000/svg" className="menu-icon">
                            ...
                            <div className="menu-title">Scam Tokens</div>
                        </a>
                    </div>
                        ...
                        { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                            <>
                                ...
                                <div className="overflow-hidden" ref={ setCollapsibleElement }>
                                    <div className="submenu">
                                        <div role="button" className="menu-item submenu-item">
                                            <a role="button" href="/pdf/TallyAudit.pdf">Audit (PDF)</a>
                                        </div>
                                        <div role="button" className="menu-item submenu-item">
                                            <a role="button" href="/hc/en-us">News</a>
                                        </div>
                                        <div role="button" className="menu-item submenu-item">
