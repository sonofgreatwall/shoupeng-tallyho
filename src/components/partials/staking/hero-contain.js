    ...
    return (
        <div className="default-hero__container">
            <div className="default-hero__body">
                ...
                <h2 className="default-hero__subtitle">Looking for a less resource-intensive alternative to mining? Use your BSW tokens to earn more tokens, for Free. <a href="https://docs.tally.org/education-hub/getting-passive-income-in-tally-launchpools" rel="noreferrer" style={{color: "#89c438"}}>Learn how it works</a></h2>
                <a href="#add-product">
